...
<script type="text/javascript">
	function confirmOrder(){
		...
		form.submit();
		//提交表单
		//window.location.href="product/confirmOrder";
	}
</script>
...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/product/confirmOrder" method="post"
