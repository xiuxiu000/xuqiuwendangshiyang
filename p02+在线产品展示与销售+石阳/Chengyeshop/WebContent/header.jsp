...
<div class="container-fluid">
	<div class="col-md-4">
		<img src="/ChengyeShop/img/biaozhi.jpg"  style="width: 110px; height:55px;" />
	</div>
	<div class="col-md-4">
		<img src="/ChengyeShop/img/header.png" />
	</div>
	<div class="col-md-4" style="padding-top:20px">
		<ol class="list-inline">
		
			<c:if test="${empty user }">
				<li><a href="/ChengyeShop/login.jsp">登录</a></li>
				<li><a href="/ChengyeShop/register.jsp">注册</a></li>
			</c:if>
			<c:if test="${!empty user }">
			...
			<li><a href="/ChengyeShop/cart.jsp">购物车</a></li>
			<li><a href="${pageContext.request.contextPath }/product/myOrders">我的订单</a></li>
			<li><a href="/ChengyeShop/admin/index.jsp">管理员</a></li>
		</ol>
	</div>
</div>
