				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotPro">
						...
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/product/productInfo?pid=${hotPro.pid}&cid=1&currentPage=1">
								<img src="${pageContext.request.contextPath }/${hotPro.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/product/productInfo?pid=${hotPro.pid}&cid=1&currentPage=1" style='color:#666'>${hotPro.pname }</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProductList }" var="newPro">
						...
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/product/productInfo?pid=${newPro.pid}&cid=1&currentPage=1">
								<img src="${pageContext.request.contextPath }/${newPro.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/product/productInfo?pid=${newPro.pid}&cid=1&currentPage=1" style='color:#666'>${newPro.pname }</a></p>
